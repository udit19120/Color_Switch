...
public class Concentric_Circle extends Obstacles {
    private Path path1;
    private Path path2;
    private Path path3;
    private Path path4;
    ...
    public Concentric_Circle(int radius, int x, int y, int width,boolean check) throws Exception {
        super(x, y, radius, width,check);
        path1 = new Path();
        path1.setStrokeWidth(width);
        path1.setStroke(Color.RED);
        MoveTo moveTo1 = new MoveTo(x, y + radius);
        ...
        MoveTo moveTo2 = new MoveTo(x + radius, y);
        ...
        MoveTo moveTo3 = new MoveTo(x, y - radius);
        ...
        MoveTo moveTo4 = new MoveTo(x - radius, y);
        ...
        int r21 = radius - width;
        path1x = new Path();
        path1x.setStrokeWidth(width);
        path1x.setStroke(Color.RED);
        MoveTo moveTo1x = new MoveTo(x, y + r21);
        ArcTo arc1x = new ArcTo();
        arc1x.setX(x + r21);
        arc1x.setY(y);

        arc1x.setRadiusX(r21);
        arc1x.setRadiusY(r21);


        path2x = new Path();
        path2x.setStrokeWidth(width);
        path2x.setStroke(Color.BLUE);
        MoveTo moveTo2x = new MoveTo(x + r21, y);
        ArcTo arc2x = new ArcTo();
        arc2x.setX(x);
        arc2x.setY(y - r21);

        arc2x.setRadiusX(r21);
        arc2x.setRadiusY(r21);

        path3x = new Path();
        path3x.setStrokeWidth(width);
        path3x.setStroke(Color.YELLOW);
        MoveTo moveTo3x = new MoveTo(x, y - r21);
        ArcTo arc3x = new ArcTo();
        arc3x.setX(x - r21);
        arc3x.setY(y);

        arc3x.setRadiusX(r21);
        arc3x.setRadiusY(r21);

        path4x = new Path();
        path4x.setStrokeWidth(width);
        path4x.setStroke(Color.HOTPINK);

        MoveTo moveTo4x = new MoveTo(x - r21, y);
        ArcTo arc4x = new ArcTo();
        arc4x.setX(x);
        arc4x.setY(y + r21);

        arc4x.setRadiusX(r21);
        arc4x.setRadiusY(r21);
        ...
        t1x.getKeyFrames().add(new KeyFrame(Duration.millis(5000), new KeyValue(r1x.angleProperty(), -360)));
        t1x.play();
        ...
        t2x.getKeyFrames().add(new KeyFrame(Duration.millis(5000), new KeyValue(r2x.angleProperty(), -360)));
        t2x.play();
        ...
        t3x.getKeyFrames().add(new KeyFrame(Duration.millis(5000), new KeyValue(r3x.angleProperty(), -360)));
        t3x.play();
        ...
        t4x.getKeyFrames().add(new KeyFrame(Duration.millis(5000), new KeyValue(r4x.angleProperty(), -360)));
        t4x.play();
